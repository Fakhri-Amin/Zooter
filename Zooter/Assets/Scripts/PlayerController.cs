...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        float currentMovementSpeed = moveSpeed + (moveSpeed * PlayerStats.Instance.GetMovementSpeed() / 100);
        rb.MovePosition(rb.position + currentMovementSpeed * Time.fixedDeltaTime * inputVector);
